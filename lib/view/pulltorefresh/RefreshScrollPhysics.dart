...
class RefreshScrollPhysics extends ScrollPhysics {
  ...
  final Function listenerEndList;

  /// Creates scroll physics that bounce back from the edge.
  const RefreshScrollPhysics({ScrollPhysics parent,this.enableOverScroll:true, this.listenerEndList}) : super(parent: parent);


  @override
  RefreshScrollPhysics applyTo(ScrollPhysics ancestor) {
    return new RefreshScrollPhysics(  parent: buildParent(ancestor),enableOverScroll: enableOverScroll, listenerEndList:listenerEndList );
  }
  ...
  double applyBoundaryConditions(ScrollMetrics position, double value) {
    if(enableOverScroll) {
      if (value < position.pixels &&
        ...
        return /*value - position.pixels;*/0.0;
      if (value < position.minScrollExtent &&
          position.minScrollExtent < position.pixels) // hit top edge
        return /*value - position.minScrollExtent;*/0.0;
