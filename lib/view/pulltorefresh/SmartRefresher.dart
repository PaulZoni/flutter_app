...
import 'package:flutter_app/view/pulltorefresh/GestureProcessor.dart';
import 'package:flutter_app/view/pulltorefresh/RefreshWrapper.dart';
import 'package:flutter_app/view/pulltorefresh/RefreshScrollPhysics.dart';
...
class SmartRefresher extends StatefulWidget {
  ...
  final Widget containerForHeader;
  final int countSize;
  final int carouselSize;

  final Function listenerTheEndList;
  ...
  SmartRefresher({
    ...
    Widget containerForHeader,//todo header
    this.countSize,
    this.carouselSize,
    ...
    this.onRefresh,
    this.onOffsetChange,
    this.listenerTheEndList,
  })  : assert(child != null),
        this.containerForHeader = containerForHeader,
...
class _SmartRefresherState extends State<SmartRefresher> {
      ...
      return Column(
        children: <Widget>[
          ...
          SizedBox(
            ...
            child: Container(
              color: Colors.blue,
              child: widget.containerForHeader,
            ),
          ),
  ...
  Widget build(BuildContext context) {
    ...
    int countElemebt = 0;
    if(widget.child.childrenDelegate.estimatedChildCount < 3) countElemebt = 5;
    else countElemebt = widget.child.childrenDelegate.estimatedChildCount;

    Container container = new Container(
      child: widget.child,
      color: Colors.white,
      width: double.infinity,
      height: ((widget.countSize + widget.carouselSize) + (62 * (countElemebt - 2))).toDouble(),
    );


    slivers.insert(0, SliverToBoxAdapter(
      child: container,
    ));
                ...
                child: new NotificationListener(
                  child: new CustomScrollView(
                    physics: new RefreshScrollPhysics(
                      listenerEndList: widget.listenerTheEndList,
